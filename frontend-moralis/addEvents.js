...
const contractAddressesss = require("./constants/networkMapping.json")

let chainId = process.env.chainId || 31337
let moralisChainId = chainId == "31337" ? "1337" : chainId
const contractAddressArray = contractAddressesss[chainId]["NftMarketplace"]
...
async function main() {
    ...
    let itemBoughtOptions = {
        ...
        address: contractAddress,
        sync_historical: true,
        topic: "ItemBought(address,uint256,address,uint256)",
        abi: {
            "anonymous": false,
            "inputs": [
                {
